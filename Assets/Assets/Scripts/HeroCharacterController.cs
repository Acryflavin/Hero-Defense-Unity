...
namespace HeroCharacter
{
    ...
    public class HeroCharacterController : MonoBehaviour, IDamageable
    {
        ...
        void SampleInput()
        {
            ...
            rotateCameraHeld = rotateCameraAction != null && rotateCameraAction.IsPressed();
        ...
        bool BindInputActions()
        {
            ...
            rotateCameraAction = FindAction(actionAsset, input.rotateCameraAction);
        ...
        void ResolveLocomotion(float deltaTime)
        {
            ...
            if (moveWorld.sqrMagnitude > kSmallNumber && rotateCameraHeld)
            {
        ...
        void UpdateCamera(float deltaTime)
        {
            ...
            Vector2 adjustedLook = rotateCameraHeld ? lookInput : Vector2.zero;
        ...
        class InputSettings
        {
            ...
            public string rotateCameraAction = "RotateCamera";
