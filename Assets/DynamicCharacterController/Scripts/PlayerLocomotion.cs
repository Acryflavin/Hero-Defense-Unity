...
public class PlayerLocomotion : MonoBehaviour
{
    ...
    private void HandleMovement()
    {
        ...
        movementVelocity.y = _playerRigidBody.linearVelocity.y;
    ...
    {
        if (_playerRigidBody.linearVelocity == Vector3.zero) return;
    ...
    public void HandleDodge()
    {
        ...
        _playerRigidBody.linearVelocity = new Vector3(0, dodgeVelocityY, 0);
    }
    ...
    private void Update()
    {
        ...
        if (!_inputManager.isMovementPressed && (_playerRigidBody.linearVelocity.x != 0 || _playerRigidBody.linearVelocity.z != 0))
        {
        ...
        {
            _playerRigidBody.linearVelocity += (_fallMultiplier - 1) * Time.deltaTime * Physics.gravity.y * Vector3.up;
        }
    }
}